...
for i in range(1000):
    ...
    with open("output.txt","a") as f:
        f.write(urllib.request.urlopen(urllib.request.urlopen('https://github.com/termux/termux-packages/commits/master?after=6b95718c6054c611ed07bbb8139e0d6ce6e7d593+' + str(page) + '&branch=master',headers=ua_headers)).read())
    page = page + 35
    print('第' + str(i + 1) + '次结束：')
print("Finished!")
